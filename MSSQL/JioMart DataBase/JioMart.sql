create database JioMartDataBase
use JioMartDatabase

create schema JioMart
--create tables
--create UserDetails table
create table JioMart.UserDetails (
...
create table JioMart.ProductDetails(
...
exec jIOmART.InsertUserDetails 0,'Rajesh','Patel','Madana(gadh),Palanpur','1234567890',0,'I'
exec jIOmART.InsertUserDetails 0,'Pankaj','Gawai','Malad,Mumbai','4568795890',0,'y'

--insert into jiomart.UserDetails values('Karan','Shah','Income tex,Ahmedabad','8974561230',0,GETDATE(),GETDATE())
--truncate table jiomart.UserDetails
...
update JioMart.ProductDetails set ProductPrice=310 where ProductDetailsId=11
EXEC JioMart.InsertProductDetails 11,'Surf excel matic liquid',330,100,10001,'u'
EXEC JioMart.INSERTPRODUCTDetails 0,'Arial matic liquid',318,100,10001,'I'
EXEC JioMart.INSERTPRODUCTDetails 13,'Parachute coconate oil',250,100,10001,'u'
...
begin transaction
insert into Jiomart.OrderDetails values(101,'UPI',240,default,getdate(),Getdate(),getdate())
insert into Jiomart.OrderDetails values(103,'UPI',280,default,getdate(),Getdate(),getdate())
insert into Jiomart.OrderDetails values(104,'Wallet',0,default,getdate(),Getdate(),getdate())
/*
...
inner join jiomart.UserDetails as UD on OD.UserDetailsId = UD.UserDetailsId
inner join jiomart.ProductName as PN on OD.ProductNameId = PN.ProductNameId
